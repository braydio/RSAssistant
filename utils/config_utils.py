...
AUTO_RSA_PATCH_ENABLED = _get_env_bool("AUTO_RSA_PATCH_ENABLED", True)
AUTO_RSA_PATCH_CHECK_MINUTES = _get_env_int("AUTO_RSA_PATCH_CHECK_MINUTES", 5)
AUTO_RSA_PATCH_STATE_FILE = _resolve_path_env(
    "AUTO_RSA_PATCH_STATE_FILE", VOLUMES_DIR / "db" / "auto_rsa_patch_state.json"
)
